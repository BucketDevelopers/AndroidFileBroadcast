	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				final CharSequence[] items = {"Open","Remove from list","Clear entire list"};
				AlertDialog.Builder dialog = new AlertDialog.Builder(File_Download.this);
				dialog.setTitle(filearray.get(pos)).setItems(items, new DialogInterface.OnClickListener() {
				...
				// TODO Auto-generated method stub
				 ...
				 case 0:		//Open that file
					 ...
					 if(MimeUtils.guessMimeTypeFromExtension(extension) == null)
						 Toast.makeText(getBaseContext(), "Unknown File Type",Toast.LENGTH_SHORT).show();
					 else{
				...
				/*	 for(int i= 0; i< filearray.size();i++)
			         {
			        	...
			        	filemap.put(filearray.get(i), xml.getFilePath(filearray.get(i)));
			         }
				*/
//					 Log.d("Hell","Map is "+filemap.toString());
		   			 filearray.remove(pos);
					 arrayadapter.notifyDataSetChanged();
					 tempfile = new File(getFilesDir(),"list.xml");
					 tempfile.delete();
			         ...
			         for(int i= 0; i< filearray.size();i++)
			         {
//			        	Log.d("attempt", "Trying "+filearray.get(i)+" at "+filemap.get(filearray.get(i)));
			        	t_xml.addFile(filearray.get(i), filemap.get(filearray.get(i)));
			         }
